    ...
    <SafeAreaView className="flex-1 bg-surface" edges={["top"]}>
      ...
      <ScrollView className="flex-1 px-4 mt-4">
        ...
        <TouchableOpacity
          ...
          className={`bg-white p-4 rounded-xl mb-4 shadow-sw flex-row items-center border-2 ${paymentMethod === "cash" ? "border-primary" : "border-transparent"}`}
        >
          <Ionicons
            name="cash-outline"
            size={24}
          ...
          />
          <View>
            <Text className="ext-base font-bold text-primary">
              Cash on Delivery
            </Text>
        ...
        <TouchableOpacity
          ...
          className={`bg-white p-4 rounded-xl mb-4 shadow-sw flex-row items-cener border-2 ${paymentMethod === "stripe" ? "border-primary" : "border-transparent"}`}
        >
          <Ionicons
            name="card-outline"
            size={24}
      ...
      <View className="p-4 bg-white shadow-lg border-t border-gray-100">
        ...
        <View className="flex-row justify-between mb-6">
          <Text className="text-primary text-xl fond-bold">Total</Text>
