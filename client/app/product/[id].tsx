    ...
    <View className="flex-1 bg-white">
      ...
      <View className="absolute bottom-0 left-0 right-0 p-4 bg-white border-t border-gray-100 flex-row items-center">
        ...
        <TouchableOpacity
          ...
          className="ml-4 w-12 h-12 bg-gray-50 rounded-full items-center justify-center relative"
        >
          <Ionicons name="cart-outline" size={24} color={COLORS.primary} />
          {itemCount > 0 && (
            <View className="absolute -top-1 -right-1 w-5 h-5 bg-black rounded-full justify-center items-center">
