...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Link href={`/product/${product._id}`} asChild>
      <TouchableOpacity className="w-[48%] mb-4 bg-white rounded-lg overflow-hidden border border-gray-100">
        <View className="relative h-56 w-full bg-gray-100">
          ...
          {/* is Featured */}
          {product.isFeatured && (
            <View className="absolute top-3 left-2 bg-black px-2 py-1 rounded">
